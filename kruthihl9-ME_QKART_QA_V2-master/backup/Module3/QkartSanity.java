...
public class QkartSanity {
    ...
    public static void takeScreenshot(WebDriver driver, String screenshotType, String description) {
         ...
         */
        try {
            File theDir = new File("/screenshoots");
            if (!theDir.exists()) {
                theDir.mkdir();
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
            ...
            if (!elementText.toUpperCase().contains("YONEX")) {
                logStatus("TestCase 3",
                        "Test Case Failure. Test Results contains un-expected values: "
                                + elementText,
                        "FAIL");
                takeScreenshot(driver, "Faild", "TestCase03");
                return false;
            }
        }
        ...
        logStatus("TestCase 3", "End test case : Verify functionality of search box ", "DONE");
        return true;
    }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        ...
        // Go to the home page
        homePage.navigateToHome();
        Thread.sleep(3000);// SLEEP_STMT_05
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        checkoutPage.placeOrder();
        Thread.sleep(3000);// SLEEP_STMT_06

        status = driver.getCurrentUrl().endsWith("/thanks");

        homePage.navigateToHome();
        Thread.sleep(3000);// SLEEP_STMT_07
        homePage.PerformLogout();
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        ...
        // Thread.sleep(3000);// SLEEP_STMT_08
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase",
                "Test Case 8: Verify In the new tab, the cart should contain the added product: YONEX Smash Badminton Racquet :",
                "DONE");
        ...
        Thread.sleep(3000);
        // code needs to write
        WebElement privacyPolicyPageLink = driver.findElement(By.linkText("Privacy policy"));
        ...
        logStatus("Step",
                "Verify In the new tab, the cart should contain the added product: YONEX Smash Badminton Racquet : ",
                status ? "PASS" : "FAIL");
        driver.close();
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (currentUrl1.equalsIgnoreCase("https://crio-qkart-frontend-qa.vercel.app/")) {
            status = true;
            System.out.println(
                    "TestCase 09: Verify that the url of the current tab does not change|  Passed");
        } else {
            status = false;
            System.out.println(
                    "TestCase 09: Verify that the url of the current tab does not change|  Failed");
        ...
        String privacyPolicytext = titlePrivacyPolicy.getText();

        if (privacyPolicytext.contains("Privacy Policy")) {
            status = true;
            System.out.println(
                    "TestCase 09: The privacy policy content is available on the newly opened tab |  Passed");
        } else {
            status = false;
            System.out.println(
                    "TestCase 09: The privacy policy content is available on the newly opened tab |  Failed");
            takeScreenshot(driver, "Failed", "TestCase09");
        }
        ...
        // Verify that the url of the current tab does not change
        if (CurrentUrl.equalsIgnoreCase("https://crio-qkart-frontend-qa.vercel.app/")) {
            status = true;
            System.out.println(
                    "TestCase 09: Verify that the url of the current tab does not change|  Passed");
        } else {
        ...
        WebElement titletermsOfService =
                driver.findElement(By.xpath("//h2[text()='Terms of Service']"));
        String termsOfServicetext = titletermsOfService.getText();

        if (termsOfServicetext.contains("Terms of Service")) {
            status = true;
            System.out.println(
                    "TestCase 09: The Terms of Service content is available on the newly opened tab |  Passed");
        } else {
            status = false;
            System.out.println(
                    "TestCase 09: The Terms of Service content is available on the newly opened tab |  Passed");
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        System.out.println("TestCase 10:  Ensure that the contact now dialog closes |  Passed");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        logStatus("Start TestCase", "Test Case 11: Verify Check for advertisements", "DONE");
        ...
        if (!status) {
            ...
            logStatus("End TestCase", "Test Case 11: Verify user Registration : ",
                    status ? "PASS" : "FAIL");
        ...
        List<WebElement> adscount = driver.findElements(By.tagName("iframe"));
        int ads = adscount.size();
        status = ads == 3;
        logStatus("Test Step", "Check for advertisement: ", status ? "PASS" : "FAIL");
        for (int i = 1; i <= 2; i++) {
        WebElement Iframe = driver.findElement(By.xpath("(//iframe)[" + i + "]"));
        ...
        logStatus("Test Step", "Check for Advertisements: ", status ? "PASS" : "FAIL");
        ...
        homePage.PerformLogout();
        logStatus("End TestCase", "Test Case 11: Verify Check for advertisements", "DONE");
        return status;
    }
