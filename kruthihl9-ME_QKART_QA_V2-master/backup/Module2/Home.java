...
public class Home {
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            WebElement quantityInput = driver.findElement(By.xpath("//div[@class='MuiBox-root css-69i1ev']/div/div"));
                    ...
                    if (quantityDifference > 0) {
                        for (int i = 0; i < quantityDifference; i++) {
                            driver.findElement(By.xpath(
                                            "//div[@class='MuiBox-root css-69i1ev']/div/button[2]"))
                                    .click();
                                    Thread.sleep(5000);
                        }
                    } else {
                        for (int i = 0; i > quantityDifference; i--) {
                            driver.findElement(
                                    By.xpath("//div[@class='MuiBox-root css-69i1ev']/div/button[1]")).click();
                                    Thread.sleep(5000);
                        }
                    }
