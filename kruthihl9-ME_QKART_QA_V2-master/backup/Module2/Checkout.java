...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            List<WebElement> listAddress = driver.findElements(
                    By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']/div/p"));
            for (WebElement address : listAddress) {
                String selectAddressValue = address.getText();
                if (selectAddressValue.equalsIgnoreCase(addressToSelect)) {
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            WebElement InsufficientMessage =
                    driver.findElement(By.xpath("//div[@id='notistack-snackbar']"));
            if (InsufficientMessage.isDisplayed()) {
                String actualMessage = InsufficientMessage.getText();
